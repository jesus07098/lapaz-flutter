...
class RestaurantProductsCreateController {
  ...
  String idCategory; // ALMACENAR EL ID DE LA CATEGORIA SELCCIONADA
  ...
  void createProduct() async {
    ...
    if (imageFile1 == null || imageFile2 == null || imageFile3 == null) {
      GeneralSnackbar.show(context, 'Selecciona las tres imagenes');
      return;
    }

    if (idCategory == null) {
      GeneralSnackbar.show(context, 'Selecciona la categoria del producto');
      return;
    }
